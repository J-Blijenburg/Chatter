<template>
    <div class="startStructure">
      <div class="startNavigation">
  
  
        <div>
          <div class="startNavigationIcons">
            <a href="">
            ...
            <p class="startNavigationIconsName">Profile</p>
          </div>
          <div class="startNavigationIcons">
            <a href="">
              <svg xmlns="http://www.w3.org/2000/svg" width="46" height="46" fill="currentColor" class="bi bi-people-fill"
                viewBox="0 0 16 16">
                <path
                  d="M7 14s-1 0-1-1 1-4 5-4 5 3 5 4-1 1-1 1H7Zm4-6a3 3 0 1 0 0-6 3 3 0 0 0 0 6Zm-5.784 6A2.238 2.238 0 0 1 5 13c0-1.355.68-2.75 1.936-3.72A6.325 6.325 0 0 0 5 9c-4 0-5 3-5 4s1 1 1 1h4.216ZM4.5 8a2.5 2.5 0 1 0 0-5 2.5 2.5 0 0 0 0 5Z" />
              </svg>
            </a>
            <p class="startNavigationIconsName">Friends</p>
          </div>
          <div class="startNavigationIcons">
            <a href="">
            ...
            <p class="startNavigationIconsName">Add</p>
          </div>
          ...
          <div class="startNavigationIcons">
            ...
            <p class="startNavigationIconsName">Chats</p>
          </div>
        </div>
        <div class="startLogOut">
          <div class="startNavigationIcons">
            <a href="">
              <svg xmlns="http://www.w3.org/2000/svg" width="42" height="42" fill="currentColor"
            ...
            <p class="startNavigationIconsName">Settings</p>
          </div>
          <button class="startBtnLogOut">Log out</button>
        </div>
      </div>
  
  
      <div class="startBase">
        <div class="startProfile">
  ...
  <style>
  @import '../assets/css/start.css';</style>